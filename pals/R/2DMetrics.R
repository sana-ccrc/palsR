...
#
TimeMeanAll = function(model,obs,bench,variable,plottype,cl,region){
...
TimeSDAll = function(model,obs,bench,variable,plottype,cl,region){
...
TimeRMSEAll = function(model,obs,bench,variable,plottype,cl,region){
...
TimeCorAll = function(model,obs,bench,variable,plottype,cl,region){
